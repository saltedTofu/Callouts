    ...
    return(
        <div className="onslaughtFullGrid">
            ...
            <div className="calloutsList" id="onslaughtCallouts">
                ...
                <p onMouseOver={() => {handleMouseOver('B Sneaky',['bSneaky'],'bSneakyText')}} onMouseOut={() => {handleMouseOut(['bSneaky'],'bSneakyText')}}  id="bSneakyText">B Sneaky</p>
                ...
                <p onMouseOver={() => {handleMouseOver('Courtyard',['courtyard','courtyard2'],'courtyardText')}} onMouseOut={() => {handleMouseOut(['courtyard','courtyard2'],'courtyardText')}}  id="courtyardText">Courtyard</p>
            ...
            <svg id="onslaughtMap" width="750px" height="625px">
                ...
                <polygon onMouseOver={() => {handleMouseOver('B Sneaky',['bSneaky'],'bSneakyText')}} onMouseOut={() => {handleMouseOut(['bSneaky'],'bSneakyText')}} id="bSneaky" points="405,501 377,501 377,524 405,524"/>
                ...
                <polygon onMouseOver={() => {handleMouseOver('Courtyard',['courtyard','courtyard2'],'courtyardText')}} onMouseOut={() => {handleMouseOut(['courtyard','courtyard2'],'courtyardText')}} id="courtyard" points="283,142 435,142 435,242 283,242"/>
                <polygon onMouseOver={() => {handleMouseOver('Courtyard',['courtyard','courtyard2'],'courtyardText')}} onMouseOut={() => {handleMouseOut(['courtyard','courtyard2'],'courtyardText')}} id="courtyard2" points="284,479 284,385 440,385 440,479"/>
